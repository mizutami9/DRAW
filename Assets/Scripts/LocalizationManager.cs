...
namespace DrawBody.Prototype
{
    public sealed class LocalizationManager : MonoBehaviour
    {
        ...
        private static readonly Dictionary<string, string> Japanese = new Dictionary<string, string>
        {
            ...
            { "ability_human_jump_gauge", "ジャンプ" },
            { "ability_human_arm_gauge", "腕力" },
            { "ability_cat_back_leg_gauge", "速さ" },
            { "ability_cat_front_leg_gauge", "爪レンジ" },
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            { "ability_human_arm_gauge", "POWER" },
            { "ability_cat_back_leg_gauge", "SPEED" },
            { "ability_cat_front_leg_gauge", "CLAW" },
        ...
        private static readonly Dictionary<string, string> GeneratedJapanese = new Dictionary<string, string>
        {
            ...
            { "ready_room_game_10_3", "弾を反射させて敵を倒そう" },
            { "ready_room_game_11_2", "最後まで生き残ろう" },
            { "ready_room_game_11_3", "ボールでブロックを全部壊そう" },
            { "ready_room_game_12_1", "箱を壊して、コインの合計を100にしよう" },
            { "ready_room_game_12_2", "制限時間内にコインを集めよう" },
            { "ready_room_game_12_3", "動くコインを追いかけて集めよう" },
            { "ready_room_game_13_1", "強い敵から味方を守ろう" },
            { "ready_room_game_13_2", "ボールを跳ね返して敵を倒そう" },
            { "ready_room_game_14_1", "制限時間内にゴールしよう" },
            { "ready_room_game_14_2", "傘で仲間を雨から守ろう" },
            { "ready_room_game_14_3", "盾をつないでミサイルを防ごう" },
            { "ready_room_game_15_1", "飛行台に乗ってクレヨンデビルを倒そう" },
            { "ready_room_game_15_2", "クレヨンストーカーから逃げて倒そう" },
            { "ready_room_game_15_3", "自分たちの姿をした敵を倒そう" },
        ...
        private static readonly Dictionary<string, string> GeneratedEnglish = new Dictionary<string, string>
        {
            ...
            { "ready_room_game_10_3", "RICOCHET SHOTS TO DEFEAT THE ENEMIES" },
            { "ready_room_game_11_2", "SURVIVE UNTIL TIME RUNS OUT" },
            { "ready_room_game_11_3", "BREAK EVERY BLOCK WITH THE BALL" },
            { "ready_room_game_12_1", "BREAK BOXES AND MAKE THE COINS ADD UP TO 100" },
            { "ready_room_game_12_2", "COLLECT COINS BEFORE TIME RUNS OUT" },
            { "ready_room_game_12_3", "CHASE AND COLLECT THE MOVING COINS" },
            { "ready_room_game_13_1", "DEFEND YOUR FRIEND FROM STRONG ENEMIES" },
            { "ready_room_game_13_2", "BOUNCE THE BALL BACK TO DEFEAT THE ENEMIES" },
            { "ready_room_game_14_1", "REACH THE GOAL BEFORE TIME RUNS OUT" },
            { "ready_room_game_14_2", "KEEP YOUR FRIENDS DRY WITH THE UMBRELLA" },
            { "ready_room_game_14_3", "LINK SHIELDS TO BLOCK THE MISSILES" },
            { "ready_room_game_15_1", "RIDE THE PLATFORM AND DEFEAT CRAYON DEVIL" },
            { "ready_room_game_15_2", "ESCAPE AND DEFEAT CRAYON STALKER" },
            { "ready_room_game_15_3", "DEFEAT THE ENEMIES WEARING YOUR FORMS" },
