...
namespace DrawBody.Prototype
{
    public sealed class LocalizationManager : MonoBehaviour
    {
        ...
        private static readonly Dictionary<string, string> GeneratedJapanese = new Dictionary<string, string>
        {
            ...
            { "stage_object_speed_ring2_x", "スピードリング x2" },
            { "stage_object_speed_ring3_x", "スピードリング x3" },
            ...
            { "mirror_brawl_phase", "PHASE {0}　CPU 残り {1}体" },
            ...
            { "side_boss_hp", "追跡ボス  残り {0} / {1}" },
            { "side_boss_ready", "3・2・1  逃走準備" },
            { "side_boss_run", "右へ逃げろ！ 緑の装置で反撃！" },
            { "side_boss_clear", "追跡ボス撃破！" },
            { "side_boss_failed", "全員つかまった…" },
            { "side_boss_barrage_warning", "弾幕が来る！" },
            { "side_boss_laser_warning", "巨大レーザー！ 高さを見ろ！" },
            { "side_boss_floor_warning", "この床が壊れる！" },
            { "side_boss_hand_warning", "巨大な手！ 高さを見ろ！" },
            { "spike_chase_run", "走れ！" },
        ...
        private static readonly Dictionary<string, string> GeneratedEnglish = new Dictionary<string, string>
        {
            ...
            { "stage_object_speed_ring2_x", "Speed Ring x2" },
            { "stage_object_speed_ring3_x", "Speed Ring x3" },
            ...
            { "mirror_brawl_phase", "PHASE {0}  CPU LEFT: {1}" },
            ...
            { "side_boss_hp", "PURSUER  {0} / {1} HITS LEFT" },
            ...
            { "side_boss_barrage_warning", "BULLET BARRAGE!" },
            { "side_boss_laser_warning", "GIANT LASER - WATCH ITS HEIGHT!" },
            { "side_boss_floor_warning", "THIS FLOOR WILL BREAK!" },
            { "side_boss_hand_warning", "GIANT HAND - WATCH ITS HEIGHT!" },
            { "spike_chase_run", "RUN!" },
