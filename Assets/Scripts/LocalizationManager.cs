...
namespace DrawBody.Prototype
{
    public sealed class LocalizationManager : MonoBehaviour
    {
        ...
        private static readonly Dictionary<string, string> Japanese = new Dictionary<string, string>
        {
            ...
            { "ability_description_slime", "体にインクを使うほど、移動・ジャンプ力アップ\nインクが少ないほど、粘着力アップ" },
            ...
            { "ability_control_slime", "F長押し：仲間に吸着" },
            ...
            { "ability_ink_cat", "後ろ足 {0:0.0}/120　前足 {1:0.0}/120 INK" },
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            { "ability_description_slime", "More body INK increases movement and jump power\nLess INK increases grip" },
            ...
            { "ability_control_slime", "HOLD F: STICK TO A FRIEND" },
            ...
            { "ability_ink_cat", "Back {0:0.0}/120  Front {1:0.0}/120 INK" },
        ...
        private static readonly Dictionary<string, string> GeneratedJapanese = new Dictionary<string, string>
        {
            ...
            { "ready_room_game_14_3", "味方の盾を作ってミサイルを防ごう" },
        ...
        private static readonly Dictionary<string, string> GeneratedEnglish = new Dictionary<string, string>
        {
            ...
            { "ready_room_game_8_3", "DEFEND YOUR FRIEND FROM THE ENEMIES" },
            ...
            { "ready_room_game_14_3", "MAKE ALLY SHIELDS TO BLOCK THE MISSILES" },
