...
namespace DrawBody.Prototype
{
    public sealed class LocalizationManager : MonoBehaviour
    {
        ...
        private static readonly Dictionary<string, string> Japanese = new Dictionary<string, string>
        {
            ...
            { "ability_human_status", "人間の能力\n腕 {0:0.0} INK\n腕力 ×{1:0.00}" },
            { "ability_cat_status", "猫の能力\n足 {0:0.0} INK\n移動速度 ×{1:0.00}" },
            { "ability_bird_status", "鳥の能力\n羽 {0:0.0} / 350 INK\n滑空速度 {1:0.00}" },
            { "ability_snake_status", "蛇の能力\n全身 {0:0.0} / 350 INK\nジャンプ力 ×{1:0.00}" },
            { "ability_slime_status", "スライムの能力\n体 {0:0.0} / 200 INK\n張り付き力 {1:0}%" },
            { "ability_card_human", "人間 － 腕力" },
            { "ability_card_cat", "猫 － ダッシュ" },
            { "ability_card_bird", "鳥 － 滑空" },
            { "ability_card_snake", "蛇 － ジャンプ" },
            { "ability_card_slime", "スライム － 張り付き" },
            { "ability_effect_human", "押し出し力 ×{0:0.00}" },
            { "ability_effect_cat", "走る速さ ×{0:0.00}" },
            { "ability_effect_bird", "ふんわり度 {0:0}%" },
            { "ability_effect_snake", "ジャンプ力 ×{0:0.00}" },
            { "ability_effect_slime", "ピタッと力 {0:0}%" },
            { "ability_ink_human", "腕 {0:0.0} / 280 INK" },
            { "ability_ink_cat", "足 {0:0.0} / 120 INK" },
            { "ability_ink_bird", "羽 {0:0.0} / 350 INK" },
            { "ability_ink_snake", "全身 {0:0.0} / 350 INK" },
            { "ability_ink_slime", "体 {0:0.0} / 200 INK" },
            { "ability_rank", "RANK {0}" },
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            { "ability_human_status", "HUMAN ABILITY\nArms {0:0.0} INK\nArm strength ×{1:0.00}" },
            { "ability_cat_status", "CAT ABILITY\nLegs {0:0.0} INK\nMove speed ×{1:0.00}" },
            { "ability_bird_status", "BIRD ABILITY\nWings {0:0.0} / 350 INK\nGlide speed {1:0.00}" },
            { "ability_snake_status", "SNAKE ABILITY\nBody {0:0.0} / 350 INK\nJump power ×{1:0.00}" },
            { "ability_slime_status", "SLIME ABILITY\nBody {0:0.0} / 200 INK\nGrip strength {1:0}%" },
            { "ability_card_human", "HUMAN - POWER" },
            { "ability_card_cat", "CAT - DASH" },
            { "ability_card_bird", "BIRD - GLIDE" },
            { "ability_card_snake", "SNAKE - JUMP" },
            { "ability_card_slime", "SLIME - GRIP" },
            { "ability_effect_human", "Push power ×{0:0.00}" },
            { "ability_effect_cat", "Run speed ×{0:0.00}" },
            { "ability_effect_bird", "Float power {0:0}%" },
            { "ability_effect_snake", "Jump power ×{0:0.00}" },
            { "ability_effect_slime", "Grip power {0:0}%" },
            { "ability_ink_human", "Arms {0:0.0} / 280 INK" },
            { "ability_ink_cat", "Legs {0:0.0} / 120 INK" },
            { "ability_ink_bird", "Wings {0:0.0} / 350 INK" },
            { "ability_ink_snake", "Body {0:0.0} / 350 INK" },
            { "ability_ink_slime", "Body {0:0.0} / 200 INK" },
            { "ability_rank", "RANK {0}" },
        ...
        private static readonly Dictionary<string, string> GeneratedJapanese = new Dictionary<string, string>
        {
            ...
            { "stage_object_breakable_wall", "壊れる壁" },
        ...
        private static readonly Dictionary<string, string> GeneratedEnglish = new Dictionary<string, string>
        {
            ...
            { "stage_object_breakable_wall", "Breakable Wall" },
