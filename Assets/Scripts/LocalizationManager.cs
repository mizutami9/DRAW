...
namespace DrawBody.Prototype
{
    public sealed class LocalizationManager : MonoBehaviour
    {
        ...
        private static readonly Dictionary<string, string> Japanese = new Dictionary<string, string>
        {
            ...
            { "option_register", "登録" },
            { "option_reset_progress", "\u30af\u30ea\u30a2\u30c7\u30fc\u30bf\u3092\u30ea\u30bb\u30c3\u30c8" },
            { "option_reset_progress_title", "\u30af\u30ea\u30a2\u30c7\u30fc\u30bf\u306e\u30ea\u30bb\u30c3\u30c8" },
            { "option_reset_progress_confirm", "\u5168\u30b9\u30c6\u30fc\u30b8\u306e\u30af\u30ea\u30a2\u8a18\u9332\u3092\u30ea\u30bb\u30c3\u30c8\u3057\u307e\u3059\u304b\uff1f\n\u97f3\u91cf\u30fb\u8a00\u8a9e\u30fb\u30d7\u30ec\u30a4\u30e4\u30fc\u540d\u30fb\u63cf\u753b\u30c7\u30fc\u30bf\u306f\u6b8b\u308a\u307e\u3059\u3002" },
            ...
            { "ability_description_slime", "Fでマウス方向へ攻撃トゲを伸ばす\n少ないINKほど長い／壁ジャンプ可能" },
            ...
            { "ability_control_slime", "F：マウス方向へトゲ攻撃" },
            ...
            { "ability_effect_slime", "トゲの長さ ×{0:0.00}" },
            ...
            { "ability_slime_hint", "F：マウス方向へトゲ攻撃！ 箱なども破壊可能／少ないINKほど長い" },
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            { "option_reset_progress", "RESET CLEAR DATA" },
            { "option_reset_progress_title", "RESET CLEAR DATA" },
            { "option_reset_progress_confirm", "Reset all stage-clear records?\nVolume, language, player name, and drawings will be kept." },
            ...
            { "ability_description_slime", "Press F to extend an attack spike toward the mouse\nLess INK makes it longer / Wall jump enabled" },
            ...
            { "ability_control_slime", "F: SPIKE TOWARD MOUSE" },
            ...
            { "ability_effect_slime", "Spike length ×{0:0.00}" },
            ...
            { "ability_slime_hint", "F: Spike toward mouse! Breaks crates and more / Less INK = longer" },
        ...
        private static readonly Dictionary<string, string> GeneratedJapanese = new Dictionary<string, string>
        {
            ...
            { "option_windowed", "\u30a6\u30a3\u30f3\u30c9\u30a6" },
            { "title_exit", "EXIT" },
            { "title_exit_confirm", "NICO DRAWを終了しますか？" },
            { "title_debug", "DEBUG" },
            ...
            { "character_switch_redraw_zone_only", "操作キャラの切り替えは書き直し床の上でのみ行えます。" },
            ...
            { "menu_continue", "続ける" },
            { "menu_to_title", "タイトルへ" },
            { "menu_retry_confirm_message", "ステージを最初からやり直しますか？" },
            { "menu_retry_confirm_yes", "リトライする" },
            { "menu_stage_select_confirm_message", "現在のステージを終了して、ステージ選択へ戻りますか？" },
            { "menu_stage_select_confirm_yes", "ステージ選択へ" },
            ...
            { "draw_species_swap_pending_title", "\u4ea4\u63db\u7533\u8acb\u4e2d" },
            { "draw_species_swap_pending_detail", "{0}\u3055\u3093\u306b\u3001{1}\u3068{2}\u306e\u4ea4\u63db\u3092\u7533\u8acb\u4e2d\u3067\u3059\u3002\n\u8fd4\u4e8b\u3092\u5f85\u3063\u3066\u3044\u307e\u3059\u2026" },
            ...
            { "ready_room_restriction_redraw_allowed", "※部屋を出た後は 書き直し床でキャラ変更・書き直し可" },
            { "ready_room_game_default", "みんなで準備してゲームを始めよう" },
            { "ready_room_game_2_3", "逃げろ。" },
            ...
            { "cat_escape_title", "2-3  巨大猫から逃げろ！" },
            { "cat_escape_room_count", "待機 {0} / {1}" },
            { "cat_escape_room_countdown", "{0}" },
            { "cat_escape_ready", "スタートまで {0}" },
            { "cat_escape_go", "走れ！" },
            { "cat_escape_wall", "みんなでひっかく  {0} / {1}" },
            { "cat_escape_wall_counter", "{0} / {1}" },
        ...
        private static readonly Dictionary<string, string> GeneratedEnglish = new Dictionary<string, string>
        {
            ...
            { "option_windowed", "WINDOWED" },
            { "title_exit", "EXIT" },
            { "title_exit_confirm", "Quit NICO DRAW?" },
            { "title_debug", "DEBUG" },
            ...
            { "character_switch_redraw_zone_only", "YOU CAN ONLY SWITCH CHARACTERS ON A REDRAW FLOOR." },
            ...
            { "menu_to_title", "Title" },
            { "menu_retry_confirm_message", "Restart this stage from the beginning?" },
            { "menu_retry_confirm_yes", "RETRY" },
            { "menu_stage_select_confirm_message", "End the current stage and return to Stage Select?" },
            { "menu_stage_select_confirm_yes", "STAGE SELECT" },
            ...
            { "draw_species_swap_pending_title", "SWAP REQUEST SENT" },
            { "draw_species_swap_pending_detail", "Waiting for {0} to respond.\nRequested swap: {1} for {2}." },
            ...
            { "draw_preset_sets_title", "PRESETS" },
            { "draw_preset_back", "BACK" },
            ...
            { "ready_room_restriction_redraw_allowed", "AFTER LEAVING: CHANGE OR REDRAW ON A REDRAW FLOOR" },
            { "ready_room_game_default", "GET READY TO START THE GAME" },
            { "ready_room_game_2_3", "RUN." },
            ...
            { "cat_escape_title", "2-3  ESCAPE THE GIANT CAT!" },
            { "cat_escape_room_count", "WAIT {0} / {1}" },
            { "cat_escape_room_countdown", "{0}" },
            { "cat_escape_ready", "STARTING IN {0}" },
            { "cat_escape_go", "RUN!" },
            { "cat_escape_wall", "TEAM SCRATCHES  {0} / {1}" },
            { "cat_escape_wall_counter", "{0} / {1}" },
            { "ricochet_round", "ROUND {0} / {1}" },
