...
namespace DrawBody.Prototype
{
    ...
    public static class StageObjectCatalog
    {
        private static readonly StageObjectCatalogEntry[] Entries =
        {
            ...
            E(StageObjectType.PickupFuseBomb, StageObjectCategory.Movable, StageObjectPlacement.Point, StageObjectKind.Pushable),
            ...
            E(StageObjectType.MissileLauncher, StageObjectCategory.Trap, StageObjectPlacement.Point, StageObjectKind.Hazard),
