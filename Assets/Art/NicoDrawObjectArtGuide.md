...
- Stage 14-3 laser relay emitter: red wall-mounted colored-pencil machine with a mounting plate, loose cable, warning stripes and cyan lens; beam color, direction and glow remain live code overlays.
- Stage 14-3 laser relay bulb: old clear incandescent bulb with visible filament and graphite socket; paired color, charging glow and light rays remain live code overlays.
